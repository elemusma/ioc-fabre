...
function fabre_engineering_stylesheets() {
...
add_action('wp_enqueue_scripts', 'fabre_engineering_stylesheets');
// for footer
function fabre_engineering_stylesheets_footer() {
...
add_action('get_footer', 'fabre_engineering_stylesheets_footer');
...
function fabre_engineering_menus() {
...
add_action('after_setup_theme', 'fabre_engineering_menus');
