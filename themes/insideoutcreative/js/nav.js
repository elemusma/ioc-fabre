...
let primaryNav = document.querySelector('.nav');
let secondaryNav = document.querySelector('.secondary-nav');
let secondaryLogo = document.querySelector('.secondary-logo');
let blankSpace = document.querySelector('.blank-space');

window.addEventListener("scroll", parallaxEffect);

function parallaxEffect() {
    blankSpace.style.height = `${(primaryNav.offsetHeight + secondaryNav.offsetHeight) - 1}px`;
    primaryNav.classList.add('position-fixed');
    primaryNav.classList.remove('position-relative');
    secondaryNav.classList.add('position-fixed');
    secondaryNav.classList.remove('position-relative');
    secondaryLogo.classList.add('position-fixed');
    secondaryLogo.classList.remove('position-absolute');
    primaryNav.style.top = `${secondaryNav.offsetHeight}px`;
    secondaryLogo.style.top = `${secondaryNav.offsetHeight}px`;
}
